...
public class ConfigInitialiser {
    ...
    private static final List<String> defaultPathConfig = Arrays.asList("reader.config.yaml", "reader.config.json",
            "config/reader.config.yaml", "config/reader.config.json");
